...
int main()
{
    cout << "Greetings!\nI am Calcy, the calculator.\nI'm here to help you with your math and ease your work.\nI give results in jet speed I am very easy to use.\nNow wait not and get started!\n"
         << endl;
    cout << "'Press 0 to quit the program anytime.'\n"
         << endl;
